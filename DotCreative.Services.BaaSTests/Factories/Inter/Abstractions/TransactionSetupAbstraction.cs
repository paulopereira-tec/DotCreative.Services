...
namespace DotCreative.Services.BaaSTests.Factories.Inter.Abstractions;

internal abstract class TransactionSetupAbstraction
{
  protected PlatformResponse _platformResult { get; set; }
  ...
  public void Setup()
  {
    ...
    // Act
    _platformResult = new PlatformFactory(platform).PlatformResult;
  }
}
