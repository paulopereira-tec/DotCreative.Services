...
public class BancoInterCreateBilletTransaction : ITransactionRequest
{
    public StringContent PrepareBilletData(TransactionInfo transactionInfo)
    {
    ...
    public async Task<string> RequestBilletFileAsync(string transactionCode, PlatformResult platformResult)
    {
        ...
        using (HttpClient client = new HttpClient(clientHandler))
        {
            ...
            String URI_Pdf_Cobranca = $"https://cdpj.partners.bancointer.com.br/cobranca/v3/cobrancas/{transactionCode}/pdf";
    ...
    public async Task<TransactionResult?> ExecuteAsync(TransactionInfo transactionInfo)
    {
        BancoInterRequestBilletDataTransaction requestTransactionData = new BancoInterRequestBilletDataTransaction();

        String URI_Emitir_Cobranca = "https://cdpj.partners.bancointer.com.br/cobranca/v3/cobrancas";
        ...
        using (HttpClient client = new HttpClient(clientHandler))
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                TransactionResult? tr = await requestTransactionData.ExecuteAsync(transactionInfo);
