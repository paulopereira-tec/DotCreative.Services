...
public class BancoInterRequestBilletDataTransaction : ITransactionRequest
{
    ...
    {
        string URI_Detalhe_Cobranca = $"https://cdpj.partners.bancointer.com.br/cobranca/v3/cobrancas/{transactionInfo.Code}";
        ...
        using (HttpClient client = new HttpClient(clientHandler))
        {
            ...
            HttpResponseMessage response_detalhe = await client.GetAsync(URI_Detalhe_Cobranca);
